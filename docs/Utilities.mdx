...
By default `useThemePostCSS` applies theme object from props on the top of defaultTheme. If you don't need the default theme, call it with empty or custom theme object parameter.
