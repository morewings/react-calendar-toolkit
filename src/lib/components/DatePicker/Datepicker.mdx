...
import Datepicker, {useThemePostCSS} from 'lib';
...
You can set CSS variables here with [`useThemePostCSS`](/utilities#usethemepostcss) hook to apply your colors and fonts.
